# -*- coding: utf-8 -*-
"""
Created on Thu Aug 17 11:12:24 2017
...
class Solution(object):
    def leastInterval(self, tasks, n):
        ...
        # task number dict
        dict_task = {k:0 for k in tasks}
        for i in tasks:
            dict_task[i] += 1
        
        list_number_task = map(list, sorted(dict_task.items(), key=lambda x:x[1] , reverse=True))
        list_execute_task = []
        IDLE = 'idle'
